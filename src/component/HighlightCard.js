    ...
    return (
        <Box w={'600px'} paddingTop={'50px'}>
            ...
            <VStack position={'absolute'} alignSelf={'center'} paddingTop={'50px'} paddingLeft={'10px'}>
                    <Text fontWeight={'600'} color={'#3F3134'} fontSize={{sm:'24px', xl:'26px'}} fontFamily={'cwTeXKai'}>{props.title}{'\n'}</Text>
                    <Text paddingTop={'15px'} w={'400px'} fontWeight={'400'} color={'#3F3134'} fontSize={{sm:'18px', xl:'22px'}} fontFamily={'cwTeXKai'}>{props.content}{'\n'}</Text>
            </VStack>
        </Box>
