    ...
    return (
        <Box className='header' paddingX={2} justifyContent={'end'} flexDirection={'row'} >
                <HStack space={5} top={5}>
                    <Link to={`/${props.link}`} style={{textDecoration: props.page === 'about' ? 'underline' : 'none', textDecorationColor: props.page === 'about' ? 'black' : 'transparent', color: props.page === 'about' ? 'black' : '#8E9D7D'}}  >
                    ...
                    <Text color={'#8E9D7D'} fontSize={{ 'sm' : '0.8rem', 'md': '1.3rem'}}>|</Text>
                    <Link to={`/${props.link}/project`} style={{textDecoration: props.page === 'project' ? 'underline' : 'none', textDecorationColor: props.page === 'project' ? 'black' : 'transparent'}}>
                    ...
                    <Text color={'#8E9D7D'} fontSize={{ 'sm' : '0.8rem', 'md': '1.3rem'}}>|</Text>
                    <Link to={`/${props.link}/interest`} style={{textDecoration: props.page === 'interest' ? 'underline' : 'none', textDecorationColor: props.page === 'interest' ? 'black' : 'transparent'}}>
