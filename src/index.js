...
const steps = [
  ...
  },
  {
    selector: '.second-step',
    position: 'center',
    content: '每位成員均有5頁的資訊，可以透過點擊螢幕上的【前後箭頭】來切換頁面，也可利用我們所設定的快捷鍵來切換頁面。',
  },
  {
    position: 'center',
    content: `鍵盤快捷鍵介紹1： \n 按下【左(◀) or 上(▲)】切換至前一頁\n 按下【右(▶) or 下(▼)】切換至後一頁`,
  ...
  },
  {
    ...
    content: '點擊左邊按鈕為網站教學，網站的每個頁面均有此按鈕，使用過程中若不知道如何使用，可以點擊此按鈕查看教學。',
  },
  {
    selector: '.fourth-step',
    position: [60, window.innerHeight*0.63],
    content: '點擊右邊按鈕會導向聯絡我們的頁面，若有任何問題或建議，歡迎透過該頁表單或是電話來聯絡我們！',
  },
  {
    position: 'center',
    content: '這是網站的最後一個導覽步驟，希望您能夠喜歡我們的網站！\n\n點擊【提示框以外】或是【點擊叉叉】即可關閉導覽。',
  },
